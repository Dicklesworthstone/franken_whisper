...
pub struct ReplayEnvelope {
    ...
    /// little-endian). The audio itself is NOT retained, so this is an
    /// integrity marker only — not a replayable reference.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub pcm_sha256: Option<String>,
    /// Honest labeling for live rows: why there is no replayable input
    /// reference and what the hash does and does not attest.
    #[serde(default, skip_serializing_if = "Option::is_none")]
