...
///
/// This schema is shared by the offline converter and the future independently
/// pinned runtime verifier. A receipt produced by the converter is not itself
/// admission authority; the verifier must still bind its exact digest and
/// package census through compiled trust roots.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
